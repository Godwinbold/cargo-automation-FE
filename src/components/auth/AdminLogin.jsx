        ...
        onSuccess: (response) => {
          ...
          if (!isAdmin) {
            ...
            setRoleAlert({
              ...
              message:
                "This portal is exclusively for System Administrators. Your account does not have Administrator privileges. Please sign in via your designated portal.",
              actionText: "Go to Partner Login",
              targetUrl: "/",
            });
            toast.error(
              "Access Restricted: This portal requires Administrator privileges.",
              {
                id: "role-mismatch-not-admin",
                duration: 7000,
              },
            );
            return;
      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-6 md:p-8 relative z-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-4" noValidate>
          ...
          <button
            ...
            className="w-full py-3 mt-8 bg-[#3DA5E0] text-[#0A2D5C] font-medium rounded-lg hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center justify-center gap-2"
          >
            {isLoading ? (
              <>
